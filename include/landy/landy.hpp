...
std::optional<pose_t> closest_point([[maybe_unused]] line_t const& p, [[maybe_unused]] line_t const& q) {
  ...
  // points with a t = 0.5?
  //
  // theres a special case where the lines overlap in multiple spots?
